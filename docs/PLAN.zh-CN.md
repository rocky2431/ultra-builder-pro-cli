...
**当前状态**：v0.10.0；四宿主 native plugin、32 个 live MCP tool、
schema 10.0（16 表）、Context Spine v2 / breadcrumb / spec-learning、持续
change/context/convergence/doctor、incident debug lane、
