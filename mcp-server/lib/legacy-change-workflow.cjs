...
// Internal compatibility implementation for pre-v0.24 workflow authority.
// Production/public callers must use change-workflow.cjs, which exposes
// Kernel-only behavior and provides no legacy/current mode switch.
