...
Version `3.0.2` is the first published release of Ultra as a cognitive-alignment harness for
...
Version 3.0.2 does not install a custom `agents/` projection. The old review workers became the
