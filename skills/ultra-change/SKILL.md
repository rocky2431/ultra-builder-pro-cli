...
| `incident` | production/runtime failure requiring diagnosis | diagnosis, diff, tests |
...
and rollback. For `quick` and `incident`, add only artifacts needed to make the
decision and evidence inspectable.
