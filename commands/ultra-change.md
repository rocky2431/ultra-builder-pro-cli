...
4. standard/major 写 delta + plan；incident 完成结构化 `diagnosis.md`。
5. 调 `change.context` 编译最小上下文；incident 先走 debugger 诊断切片。
6. 路由到 `/ultra-dev`、`/ultra-test`、`/ultra-review`、`/ultra-deliver`。
